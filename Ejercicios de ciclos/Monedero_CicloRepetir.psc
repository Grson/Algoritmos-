...
Algoritmo Monedero_CicloRepetir
		...
		//Repetir hasta que llegue a una cantidad ya que no se sabe cuanto ingresará el usuario
		Repetir
			...
			si salir>0 Entonces
				...
				contadorMonedero<- contadorMonedero+1;
			SiNo
				//Si ingresa 0 el contador se vuelve 1000 para terminar el ciclo
				contadorMonedero<-1000;
			FinSi
			
		Hasta Que contadorMonedero=1000
