...
Algoritmo Monedero_CicloPara
	...
	//El ciclo debe ser inverso ya que no se saben cuando se terminará de ingresar
	Para contadorMonedero<-1000 Hasta 1 Con Paso -1 Hacer
